...
where A.name not in ('worktable','WorkFileGroup_fake_worktable','workfile','sort_fake_worktable','sort_init','LobStorageProviderSession','GhostCleanupTask','topn_fake_worktable')
